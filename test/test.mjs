...
runner.test('join', function () {
  a.strictEqual(byteSize(1000).join(), '1.0,kB')
  a.strictEqual(byteSize(-1000).join(), '-1.0,kB')
  a.strictEqual(byteSize(-1000).join(' '), '-1.0 kB')
  a.strictEqual(byteSize(1000).join(''), '1.0kB')
  a.strictEqual(byteSize(1000).join('XYZ'), '1.0XYZkB')
  a.strictEqual(byteSize(3234545234235342436356534635465).join('XYZ'), '3.2345452342353426e+30')
})
